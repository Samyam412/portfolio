...
export default function SplitText({
  ...
  return (
    <div
      className={cn(
        "cursor-sword relative mx-auto text-xl font-black uppercase text-primary md:text-4xl lg:text-6xl",
        className,
      )}
    >
      ...
      <div className="absolute top-0 flex h-full">
        {text.split("").map((letter, index) => (
          <div
            ...
            key={index}
            className="cursor-sword relative inline-flex h-full flex-col leading-none"
          >
            {/** top half */}
            <span
